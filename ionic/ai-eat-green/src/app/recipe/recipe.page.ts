...
export class RecipePage implements OnInit {
  ...
  recipe_preparation = [
    "slice zucchini into fettuccine noodles with a vegetable peeler or mandolin. If you have a spiral vegetable cutter, it will make beautiful spaghetti noodles!",
